"""Build and render the official book with M11's metric-preparation amendments."""
...
def main():
    ...
    stage = Path("/tmp/bayesfilter-hmc-m11-guide-20260920-r1")
    ...
    rendered = []
    for label, needle in (("boundary", "boundeddual-averagingaverage"),
                          ("schedule", "localdiagnosticallocation")):
    ...
    record = {"command": command, "working_directory": str(stage), "returncode": process.returncode,
        ...
        "result_file": "docs/plans/bayesfilter-hmc-repair-m11-result-2026-09-20.md",
