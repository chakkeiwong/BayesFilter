...
report = {
    ...
    "reporting_retry": "Initial metadata lookup used tensorflow-probability; installed distribution is tfp-nightly. Original script preserved; retry cost included in inspection overhead.",
}
