...
parser.add_argument("--mode", choices=("prefix", "cached-gradient", "covariance", "eigensystem", "refinement", "full-filter", "factor-filter", "candidate"), default="prefix")
