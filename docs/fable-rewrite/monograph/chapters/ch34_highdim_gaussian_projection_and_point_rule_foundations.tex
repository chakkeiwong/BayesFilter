...
Chapter~\ref{ch:bf-highdim-nonlinear-foundations} motivates the same
Gaussian-projection questions studied here, and it reappears concretely in the
next chapter's worked scalar example; the present chapter stays at the level of
Gaussian carried objects and deterministic moment engines.  Low-dimensional cloud construction,
