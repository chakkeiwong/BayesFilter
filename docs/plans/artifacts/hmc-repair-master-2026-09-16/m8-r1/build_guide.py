...
def main():
    ...
    stage = Path("/tmp") / ("bayesfilter-hmc-m8-guide-20260918-" + args.revision)
    ...
    needles = {"acceptance": "stationary acceptance", "stopping": "conditional on an available", "matched": "Matched consumer comparisons", "coverage": "C / H / P"}
    rendered = []
    ...
    result = {
        ...
        "result_file": "docs/plans/bayesfilter-hmc-repair-m8-result-2026-09-18.md",
