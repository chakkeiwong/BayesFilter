...
The [execution plan](younis-score-master-execution-plan-2026-09-14.md) turns
this specification into implementation packages E0--E7. Its first milestone
is a runnable baseline study; full active-method integration and scientific
comparison are later milestones. Every implementation package and scientific
phase now requires the repair and next-phase refresh procedure below.
...
or renewed permission within an authorized campaign. The coordinator must
test repair/resume, stale-evidence invalidation, shared-code effects, blocked
branches, budget exhaustion, and the terminal repair case. The
[execution plan](younis-score-master-execution-plan-2026-09-14.md) specifies
those tests and the initial build order.
