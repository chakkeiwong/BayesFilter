...
\eqref{eq:bf-pfpf-alg1-covariance-lifecycle} is a reviewed BayesFilter implementation choice; it is not a claim that the
paper's reported experiments used UKF in every scenario.
...
The next boundary can be stated sharply.  After
