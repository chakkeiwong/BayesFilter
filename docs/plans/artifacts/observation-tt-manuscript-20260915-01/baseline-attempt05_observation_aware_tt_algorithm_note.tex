...
the single allowed solver repair have now been used. The authorized numerical
comparison is complete; further experimentation requires a new bounded plan.
