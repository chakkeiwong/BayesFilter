"""Bounded M31--M38 worker with explicit device policy and preserved attempt costs."""
import argparse
import datetime
import hashlib
import json
...
root = args.phase_root.resolve() / args.name
...
manifest = {'command': command, 'cwd': str(source), 'git_commit': commit,
    ...
    'execution_note': 'docs/plans/bayesfilter-hmc-m31-m38-execution-2026-09-23.md',
