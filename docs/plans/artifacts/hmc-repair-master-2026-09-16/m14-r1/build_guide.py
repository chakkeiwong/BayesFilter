"""Build and render the official book with M14's metric-probe amendment."""
...
def main():
    ...
    stage = Path("/tmp/bayesfilter-hmc-m14-guide-20260921-r1")
    ...
    rendered = []
    for label, needle in (("count-capable-schedule", "allocatesslowwindowslarge"),):
    ...
    record = {"command": command, "working_directory": str(stage), "returncode": process.returncode,
        ...
        "result_file": "docs/plans/bayesfilter-hmc-repair-m14-result-2026-09-21.md",
