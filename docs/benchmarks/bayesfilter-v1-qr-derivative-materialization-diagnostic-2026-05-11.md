...
benchmark_selector = derivatives
modes = ('graph',)
shape_ladder = None
```
...
The JSON file is authoritative: `docs/benchmarks/bayesfilter-v1-qr-derivative-materialization-diagnostic-2026-05-11.json`.

| Benchmark | Backend | Mode | T | n | m | p | Warmup s | First s | Steady s | RSS delta MB | Max RSS delta MB | Points | Status |
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| linear_qr_score | tf_qr_sqrt_score | graph | 4 | 2 | 2 | 2 | 2.4352 | 0.0030 | 0.0025 | 123.0039 | 123.0039 |  | ok |
| linear_qr_score_hessian | tf_qr_sqrt | graph | 4 | 2 | 2 | 2 | 11.6858 | 0.0047 | 0.0048 | 636.0000 | 636.0000 |  | ok |
