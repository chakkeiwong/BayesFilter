"""Run the 2026-07-31 higher-level SVX-SGQF repair admission ladder."""
...
PROGRAM_ID = "neutra-four-blocked-target-repair-20260731"
CELL_ID = "SVX-SGQF"
CANDIDATE_LEVELS = (10, 12, 16, 20, 24)
REFERENCE_LEVEL = 32
PREFIX_HORIZON = 20
DENSE_ORDER = 401
DENSE_RADIUS = 8.0
...
PLAN_PATH = Path(
    "docs/plans/bayesfilter-neutra-four-blocked-target-repair-and-admission-"
    "plan-2026-07-31.md"
)
NONCLAIMS = (
...
def run_admission(output_root: Path) -> Mapping[str, Any]:
    ...
    ordered_next = {
        ...
        for level, next_level in zip(
            CANDIDATE_LEVELS,
            (*CANDIDATE_LEVELS[1:], REFERENCE_LEVEL),
        )
    }
    ...
    result = {
        "schema": "bayesfilter.neutra_svx_sgqf_repair_admission.v1",
        "program_id": PROGRAM_ID,
        "cell_id": CELL_ID,
        "passed": bool(passed),
        "decision": (
...
def _run_manifest(
    *,
    ...
    return {
        "schema": "bayesfilter.neutra_svx_sgqf_repair_run_manifest.v1",
        "program_id": PROGRAM_ID,
        "cell_id": CELL_ID,
        ...
        "command": (
            ...
            "docs/benchmarks/run_neutra_svx_sgqf_repair_admission_20260731.py "
