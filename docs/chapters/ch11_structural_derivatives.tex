...
\label{eq:bf-structural-map}
  ...
  \right).
\end{equation}
The MacroFinance source map uses the same contract for
$(b,F,Q,a,H,R)$ under source label \texttt{eq:structural\_map\_g}; BayesFilter
adds $(m_0,P_0)$ because the filtering scan cannot be differentiated without an
