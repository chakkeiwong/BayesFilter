"""Snapshot a committed base plus only M29-owned edits."""
...
paths=["bayesfilter","tests","pytest.ini","docs/benchmarks/audit_hmc_m27_2026_09_23.py", "docs/reference/hmc-tuning-interface.md", "docs/plans/bayesfilter-hmc-post-m28-next-phase-2026-09-23.md"]
