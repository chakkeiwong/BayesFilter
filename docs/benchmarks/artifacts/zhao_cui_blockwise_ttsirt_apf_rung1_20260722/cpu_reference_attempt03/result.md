...
Status: `PASS_CPU_REFERENCE_PRECHECK`
...
| primary_criterion_status | `not_assessed_nonclaiming_execution` |
| veto_diagnostic_status | `passed` |
| main_uncertainty | `synthetic independent blocks and diagnostic finite-grid KR only` |
| next_justified_action | `fresh authorized canonical trusted-GPU claim run` |
...
| exact_uniform_auxiliary | 0.571157 | 0.00300264 | -89.2121658 |
| fitted_ttsirt_uniform_auxiliary | 0.562903 | 0.00384617 | -89.2182159 |
