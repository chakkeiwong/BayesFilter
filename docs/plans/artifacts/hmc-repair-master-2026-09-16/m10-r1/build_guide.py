"""Build and render the official book with M10's metric-preparation amendments."""
...
def main():
    ...
    stage = Path("/tmp/bayesfilter-hmc-m10-guide-20260920-r1")
    ...
    rendered = []
    for label, needle in (("metric", "metric_evidence_policy"),
    ...
    record = {"command": command, "working_directory": str(stage), "returncode": process.returncode,
        ...
        "result_file": "docs/plans/bayesfilter-hmc-repair-m10-result-2026-09-20.md",
