...
surrogate unless the sampler is explicitly corrected for that surrogate.
...
return a deterministic low log density and finite fallback gradient for known
invalid regions, while separately recording diagnostics for the reason.  A
linear-algebra failure that aborts the process is not an HMC-compatible failure
mode.
