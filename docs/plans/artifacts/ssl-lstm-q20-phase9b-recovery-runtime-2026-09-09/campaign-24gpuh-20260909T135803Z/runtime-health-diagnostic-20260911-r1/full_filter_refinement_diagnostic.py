...
backend = "tensorflow_eigh_strict_factor_cached" if args.factor else "tensorflow_eigh_strict"
...
def compile_evaluation(callback):
    ...
    def evaluate(batch):
        ...
        value, score, diagnostics = callback(
            ...
            placement_floor=0.0, innovation_floor=1e-12, principal_sqrt_backend=backend,
        )
