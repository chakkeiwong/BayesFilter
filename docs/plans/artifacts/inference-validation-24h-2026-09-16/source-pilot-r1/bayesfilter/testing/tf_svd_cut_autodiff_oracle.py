"""Testing-only autodiff oracle for smooth-branch SVD-CUT derivatives."""
...
def _checked_smooth_value(
    ...
    assertions = [
        ...
        tf.debugging.assert_all_finite(
            value,
            "blocked_nonfinite_value: SVD-CUT value is nonfinite",
        ),
    ]
...
def tf_svd_cut4_score_hessian_autodiff_oracle(
    ...
    *,
    ...
    """Return a raw-GradientTape score/Hessian oracle for tests only.

    This function differentiates the implemented SVD-CUT4 value path and is
    intentionally housed under ``bayesfilter.testing``.  It is useful for
    smooth-branch parity tests, but it is not a production analytic derivative
    backend.
    """
    ...
    extra = {
        **block_metadata,
        ...
        "derivative_method": "tensorflow_autodiff_testing_oracle",
    }
    diagnostics = TFFilterDiagnostics(
        backend="tf_svd_cut4_score_hessian_autodiff_oracle",
        ...
        regularization=TFRegularizationDiagnostics(
            ...
            psd_projection_residual=raw_diagnostics[
                "innovation_psd_projection_residual"
            ],
            implemented_covariance=raw_diagnostics[
                "implemented_innovation_covariance"
            ],
            branch_label="svd_cut4_smooth_derivative_testing_oracle",
    ...
    return TFFilterDerivativeResult(
        ...
        metadata=structural_filter_metadata(
            model,
            filter_name="tf_svd_cut4_score_hessian_autodiff_oracle",
            differentiability_status="testing_autodiff_score_hessian",
...
# Backward-compatible testing alias.  Keep the short name out of production
# public exports; tests may import it from this module directly.
tf_svd_cut4_score_hessian = tf_svd_cut4_score_hessian_autodiff_oracle
