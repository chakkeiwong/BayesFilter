...
_DIRECT_EXPORTS = {
    ...
    "HMCRepairAction": "bayesfilter.inference.hmc_candidate_set_tuning",
    "HMCSharedInvalidity": "bayesfilter.inference.hmc_candidate_set_tuning",
    "HMCTuningCandidateRecord": "bayesfilter.inference.hmc_candidate_set_tuning",
    "HMCTuningCandidateSetController": "bayesfilter.inference.hmc_candidate_set_tuning",
    "HMCTuningCandidateSetResult": "bayesfilter.inference.hmc_candidate_set_tuning",
    "HMCTuningScopeCollection": "bayesfilter.inference.hmc_candidate_set_tuning",
    "HMCVerificationReceipt": "bayesfilter.inference.hmc_candidate_set_tuning",
    "HMCWorkItem": "bayesfilter.inference.hmc_candidate_set_tuning",
    "HMC_CANDIDATE_SET_ADAPTER_SCHEMA": "bayesfilter.inference.hmc_candidate_set_adapters",
    "HMCTypedCandidateSetAdapter": "bayesfilter.inference.hmc_candidate_set_adapters",
    "HMCCandidateExecutionConfig": "bayesfilter.inference.hmc_candidate_set_execution",
    "HMCAcceptancePolicy": "bayesfilter.inference.hmc_verification",
    "HMCCandidateExecutionBinding": "bayesfilter.inference.hmc_candidate_set_execution",
    "bind_hmc_candidate_set_execution": "bayesfilter.inference.hmc_candidate_set_execution",
    "bind_hmc_candidate_set_execution_from_preparation": "bayesfilter.inference.hmc_candidate_set_execution",
    "HMCCandidateRetainedRunner": "bayesfilter.inference.hmc_candidate_set_retained",
    "build_retained_bound_hmc_archive_runner_from_candidate_set_result": "bayesfilter.inference.hmc_candidate_set_retained",
    "build_retained_frozen_kernel_hmc_adapter_from_candidate_set_result": "bayesfilter.inference.hmc_candidate_set_retained",
    "build_claim_bearing_retained_frozen_kernel_hmc_adapter_from_candidate_set_result": "bayesfilter.inference.hmc_candidate_set_retained",
    "load_hmc_candidate_retained_runner": "bayesfilter.inference.hmc_candidate_set_retained",
    "HMCTypedCandidateSetRun": "bayesfilter.inference.hmc_candidate_set_adapters",
    "issue_hmc_candidate_set_adapter": "bayesfilter.inference.hmc_candidate_set_adapters",
    "run_typed_hmc_candidate_set": "bayesfilter.inference.hmc_candidate_set_adapters",
    "candidate_set_result_payload": "bayesfilter.inference.hmc_candidate_set_artifacts",
    "load_candidate_set_result_payload": "bayesfilter.inference.hmc_candidate_set_artifacts",
    "resume_hmc_candidate_set": "bayesfilter.inference.hmc_candidate_set_artifacts",
    "resume_hmc_candidate_set_tuning": "bayesfilter.inference.hmc_candidate_set_checkpoint",
    "load_numerical_tuning_checkpoint": "bayesfilter.inference.hmc_candidate_set_checkpoint",
    "resume_position_field_candidate_tuning": "bayesfilter.inference.hmc_candidate_set_position_field",
    "require_verified_member": "bayesfilter.inference.hmc_candidate_set_artifacts",
    "write_candidate_set_result": "bayesfilter.inference.hmc_candidate_set_artifacts",
    "tune_hmc_candidate_set": "bayesfilter.inference.hmc_candidate_set_tuning",
