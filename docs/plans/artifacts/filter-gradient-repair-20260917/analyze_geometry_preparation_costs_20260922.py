...
def main():
    ...
    parser.add_argument('--kind', choices=('posterior_native', 'uniform_public', 'geometry_control', 'geometry_fit', 'geometry_pilot_scalar', 'geometry_pilot_batch', 'geometry_preparation_directions', 'geometry_preparation_partition', 'geometry_preparation_design_scalar', 'geometry_preparation_design_batch'), required=True)
    ...
    filename, role = {
        'geometry_preparation_directions': ('geometry-preparation-memory-directions.json', 'descriptive_geometry_preparation_directions_cost'),
        'geometry_preparation_partition': ('geometry-preparation-memory-partition.json', 'descriptive_geometry_preparation_partition_cost'),
        'geometry_preparation_design_scalar': ('geometry-preparation-memory-design_scalar.json', 'descriptive_geometry_preparation_design_scalar_cost'),
        'geometry_preparation_design_batch': ('geometry-preparation-memory-design_batch.json', 'descriptive_geometry_preparation_design_batch_cost'),
        'geometry_pilot_scalar': ('geometry-pilot-memory-scalar.json', 'descriptive_prepared_geometry_pilot_scalar_cost'),
        'geometry_pilot_batch': ('geometry-pilot-memory-batch.json', 'descriptive_prepared_geometry_pilot_batch_cost'),
        'geometry_fit': ('geometry-fit-memory.json', 'descriptive_complete_geometry_fit_suffix_cost'),
