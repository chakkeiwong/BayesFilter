...
\]
The rule is symmetric, has positive weights, and is designed to integrate
Gaussian polynomials through degree five.  By contrast, the usual
$2n+1$ unscented rule is commonly described as third-degree accurate for
Gaussian moment propagation.  The extra corner points are what allow CUT4-G to
match cross moments such as $\mathbb{E}[Z_i^2Z_j^2]$ that axis-only rules do not
