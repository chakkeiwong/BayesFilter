...
Date: 2026-09-02
Status: `PHASE8C_VALIDITY_PASS_CANDIDATE_UNPROMOTED`
Owner: chakwong
Scope: generic observation-informed proposals for the C2 diagnostic fixture
Last reviewed: 2026-09-05 (Phase 8C fresh-data validity close,
MathDevMCP/Lean audit, branch-aware comparison repair, and GPU/XLA parity)
Readiness: `PHASE8D_FROZEN_CONTROL_REPLICATION_READY`
...
Current status is `PHASE8C_VALIDITY_PASS_CANDIDATE_UNPROMOTED`.
The immediate readiness decision is `PHASE8D_FROZEN_CONTROL_REPLICATION_READY`.
...
The next action is Phase 8D frozen-control replication under its own plan. It
must use new observation seeds, retain the selected schedule without ESS-based
retuning, preserve the exact complete-mixture weights, and report uncertainty
as descriptive unless the replication budget is expanded. This remains a
generic candidate method, not a threshold adjustment or a model-specific
