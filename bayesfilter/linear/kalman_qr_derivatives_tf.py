...
from bayesfilter.linear.kalman_second_order_tf import qr_kalman_second_order
...
def tf_qr_sqrt_kalman_score_hessian(
    ...
    return qr_kalman_second_order(
        y, tf.ones_like(y, dtype=tf.bool),
        (mean, dmean, ddmean),
        (initial_state_covariance, d_initial_state_covariance, d2_initial_state_covariance),
        (transition_offset, d_transition_offset, d2_transition_offset),
        (transition_matrix, d_transition_matrix, d2_transition_matrix),
        (transition_covariance, d_transition_covariance, d2_transition_covariance),
        (observation_offset, d_observation_offset, d2_observation_offset),
        (observation_matrix, d_observation_matrix, d2_observation_matrix),
        (observation_covariance, d_observation_covariance, d2_observation_covariance),
        _to_tensor(jitter, dtype),
    )
...
def tf_qr_sqrt_kalman_score_factors_batched_static(
    ...
    """XLA factor-native batched QR log likelihood and analytic score.
    ...
    The numerical recurrence is compiled; complete consumer targets must also
    compile their model construction and callbacks inside a stable boundary.
    """
