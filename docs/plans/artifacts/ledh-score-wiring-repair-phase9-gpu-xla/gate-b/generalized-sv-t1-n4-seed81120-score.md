...
- JSON: `docs/plans/artifacts/ledh-score-wiring-repair-phase9-gpu-xla/gate-b/generalized-sv-t1-n4-seed81120-score.json`
- Status: `completed`
...
- Memory: `{'score_memory_budget_pass': True, 'full_row_memory_gate_applicable': False, 'n10000_memory_pass': None, 'peak_mib': 0.04150390625, 'budget_mib': 14000.0, 'source': 'score_gpu_memory_info_after'}`
