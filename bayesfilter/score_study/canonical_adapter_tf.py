...
def gaussian_direction_inputs(theta, direction, initial_noise, d, o):
    ...
    return model, initial, dinitial, P, dP, H, dH, Q, dQ
...
def make_canonical_kernel(dimension, observation_dimension, particles, horizon,
    ...
    def kernel(theta, direction, observations, initial_noise, noise, reset_design):
        ...
        result = canonical_value_and_analytical_score(
            ...
            reset_design=reset_design, return_trace=return_diagnostics, **controls)
        value,directional_score=result[:2]
