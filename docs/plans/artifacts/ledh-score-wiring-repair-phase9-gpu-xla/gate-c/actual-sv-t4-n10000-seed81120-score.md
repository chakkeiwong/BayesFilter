...
- JSON: `docs/plans/artifacts/ledh-score-wiring-repair-phase9-gpu-xla/gate-c/actual-sv-t4-n10000-seed81120-score.json`
- Status: `completed`
...
- Memory: `{'score_memory_budget_pass': True, 'full_row_memory_gate_applicable': False, 'n10000_memory_pass': True, 'peak_mib': 35.22705078125, 'budget_mib': 14000.0, 'source': 'score_gpu_memory_info_after'}`
