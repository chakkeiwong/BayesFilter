...
- JSON artifact: `docs/benchmarks/kalman_qr_batched_score_smoke_float32_cpu_xla_2026-07-09.json`
- Plan: `docs/plans/bayesfilter-kalman-qr-dtype-batched-score-phase7-correctness-benchmark-subplan-2026-07-09.md`
- Command: `scripts/benchmark_kalman_qr_parameter_count_scaling.py --dimensions 10 --parameter-counts 50 --timesteps 8 --repeats 1 --batch-size 2 --device cpu --jit-compile --dtype float32 --output-json docs/benchmarks/kalman_qr_batched_score_smoke_float32_cpu_xla_2026-07-09.json --output-md docs/benchmarks/kalman_qr_batched_score_smoke_float32_cpu_xla_2026-07-09.md`
- Device: `/CPU:0`
- JIT compile: `True`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | ---: | --- |
| (10,10) | 50 | 2 | 22.7929 | 0.0753426 | 0.0491204 | 0.0712403 | 0.00871939 | 0.177511 | 1.45032 | `value={'batch_native_analytical_qr_score': 'float32', 'scalar_analytical_row_loop': 'float32', 'autodiff_row_loop_qr_score': 'float32'}; score={'batch_native_analytical_qr_score': 'float32', 'scalar_analytical_row_loop': 'float32', 'autodiff_row_loop_qr_score': 'float32'}` | 4.657e-09 | `True` |
