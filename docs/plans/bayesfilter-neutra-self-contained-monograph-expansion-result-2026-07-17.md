...
The final clean prospective-commit monograph is `docs/main.pdf` (400 pages).
...
| Full `latexmk -pdf -interaction=nonstopmode -halt-on-error main.tex` | pass: 400 pages in an isolated `HEAD` plus NeuTra worktree |
...
- Full PDF SHA-256 at close:
  `f7e72751e89a183131b112c9983274f9b294b502233e8f14452d1b1bc3ae9251`.
