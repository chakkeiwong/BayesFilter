...
def main():
    ...
    parser.add_argument('--kind', choices=('posterior_native', 'uniform_public', 'geometry_control', 'geometry_fit', 'geometry_pilot_scalar', 'geometry_pilot_batch'), required=True)
