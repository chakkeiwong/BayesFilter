"""Reconcile the bounded M30 profiling campaign from outer attempt receipts."""
...
def reconcile(root: Path, *, terminal: bool) -> dict:
    opening_file = root.parent / "m29-r1/reconciliation-terminal.json"
    ...
    return {
        "schema": "bayesfilter.hmc_m30_reconciliation.v1",
        "phase": "M30",
        "updated_utc": dt.datetime.now(dt.timezone.utc).isoformat(),
        "opening_ledger": "docs/plans/artifacts/hmc-repair-master-2026-09-16/m29-r1/reconciliation-terminal.json",
