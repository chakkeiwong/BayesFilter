...
\begin{description}
  ...
  Historical eigenderivative UKF/SVD routes are retained primarily for
  ...
  comparison against the promoted principal-square-root branch.
...
\begin{enumerate}[label=(\roman*)]
  ...
  \item only then attempt DSGE-scale sigma-point HMC on the promoted strict-SPD principal-square-root derivative route, using the historical eigenderivative/SVD branch only as a diagnostic comparison or bounded oracle;
...
problems.  The later high-dimensional, geometry, and case-study chapters use this register as the
