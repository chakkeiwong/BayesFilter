...
def validate_study(study: dict, registry: Registry) -> list[dict]:
    ...
    for row in rows:
        ...
        if row["proposal"] == "iapf" and role != "mechanics":
