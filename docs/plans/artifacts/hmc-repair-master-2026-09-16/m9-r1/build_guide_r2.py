"""Build and render the official book with M9's startup and search amendments."""
...
def main():
    ...
    output = ROOT/"guide-r2"
    stage = Path("/tmp/bayesfilter-hmc-m9-guide-20260919-r2")
    ...
    rendered = []
    for label, needle in (("startup", "bootstrap_initialization_rounds"),
                          ("interval", "explore_failed_intervals")):
    ...
    record = {"command": command, "working_directory": str(stage), "returncode": process.returncode,
        ...
        "result_file": "docs/plans/bayesfilter-hmc-repair-m9-result-2026-09-19.md",
