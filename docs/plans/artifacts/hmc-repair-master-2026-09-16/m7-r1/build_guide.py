...
def main():
    ...
    stage = Path("/tmp") / ("bayesfilter-hmc-m7-guide-20260917-" + args.revision)
    ...
    needles = {"exploration": "exploration cap", "replay": "same live",
               "validation": "complete Metropolis", "profile": "host profile", "coverage": "C/H/P",
               "requirements": "inferred suite requirements"}
    rendered = []
