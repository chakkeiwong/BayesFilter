...
Authoritative JSON artifact: `docs/benchmarks/artifacts/sgqf_whole_highdim_leaderboard_repair_20260722/attempt06/sgqf-column/result.json`.
...
| zhao_cui_generalized_sv_synthetic_from_estimated_values | fixed_sgqf | executed_value_score | analytical_score_emitted | not_claimed_no_reviewed_batched_main_row_evaluator | trusted_row_specific_gpu_xla_pass | not_ranked_by_phase7_timing | -1.426580 | 3.629262 | n/a | SGQF score vector emitted by reviewed analytical fixed-branch score path |
