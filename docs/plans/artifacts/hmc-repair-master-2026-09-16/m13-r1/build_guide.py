"""Build and render the official book with M13's metric-probe amendment."""
...
def main():
    ...
    stage = Path("/tmp/bayesfilter-hmc-m13-guide-20260921-r1")
    ...
    rendered = []
    for label, needle in (("preparation-recovery", "preparation_max_restarts"),):
    ...
    record = {"command": command, "working_directory": str(stage), "returncode": process.returncode,
        ...
        "result_file": "docs/plans/bayesfilter-hmc-repair-m13-result-2026-09-21.md",
