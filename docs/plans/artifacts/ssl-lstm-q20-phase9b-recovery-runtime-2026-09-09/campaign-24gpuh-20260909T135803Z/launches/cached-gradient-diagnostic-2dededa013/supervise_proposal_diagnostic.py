...
parser.add_argument("--mode", choices=("prefix", "cached-gradient"), default="prefix")
...
with (CAMPAIGN / ".coordinator.lock").open("a+b") as lock:
    ...
    mode_arguments = ("--sample-chain-results", "159") if args.mode == "prefix" else ("--cached-gradient",)
