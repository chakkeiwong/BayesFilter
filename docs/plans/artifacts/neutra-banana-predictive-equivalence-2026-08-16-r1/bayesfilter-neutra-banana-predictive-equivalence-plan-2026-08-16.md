...
| Artifact | `docs/plans/artifacts/neutra-banana-predictive-equivalence-2026-08-16-r1/` with plan copy, manifest, samples hashes, calibration/candidate JSON, result note, and artifact hashes. |
