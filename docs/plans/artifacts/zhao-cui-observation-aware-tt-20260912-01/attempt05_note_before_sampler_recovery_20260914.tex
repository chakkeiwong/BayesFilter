...
\begin{equation}
 ...
 \quad b_j=\exp\{(\ell_j-\log c)/2\},\quad
...
reloads. MathDevMCP checks are scoped to the stated algebraic obligations;
its detailed outcome and the fresh execution results are reported below.
