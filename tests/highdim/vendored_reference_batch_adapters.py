"""VENDORED REFERENCE — do not edit.

Verbatim copy of `bayesfilter/highdim/cubature_genut_batch_adapters.py`
at commit 43de3cb6^ (the parent of the P7 deletion), vendored 2026-08-24
as the INDEPENDENT REFERENCE for model-fidelity differential gates
(class-2 referent: written by the original author, not the canonical-lane
onboarder). The import of the deleted BatchCandidateModelAdapter is
replaced by a minimal local stand-in with the same constructor signature.
"""
...
class BatchCandidateModelAdapter:  # minimal stand-in (original deleted at P7)
    def __init__(self, state_dim, parameter_count, initial_value,
                 initial_tangent, transition_value, transition_tangent,
                 observation_value, observation_tangent):
        self.state_dim = state_dim
        self.parameter_count = parameter_count
        self.initial_value = initial_value
        self.initial_tangent = initial_tangent
        self.transition_value = transition_value
        self.transition_tangent = transition_tangent
        self.observation_value = observation_value
        self.observation_tangent = observation_tangent
