"""Post-run diagnostic analysis of complete public sequential cost comparisons."""
...
def analyze(root, first, last, devices):
    ...
    for number in range(first, last + 1):
        ...
        result_path = directory / 'sequential-public-memory.json'
        ...
        assert result['schema'] == 'filter_sequential_public_cost.v1'
        assert result['numerical_authority'] == '3582b4ac' and result['mechanism_baseline'] == '48acf5e96'
    ...
    return {'schema': 'filter_sequential_public_cost_comparison.v1', 'comparisons': comparisons,
        ...
        'nonclaims': ['Three process replicates are descriptive cost/repair evidence, not a general performance ranking.',
            ...
            'This public sequential endpoint cannot close other endpoints, whole-repository compliance or HMC readiness.']}
